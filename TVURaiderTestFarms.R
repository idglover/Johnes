...
for (i in farms){
  ...
  con <- dbConnect(RSQLite::SQLite(), paste0(path,FARM,".tvu"))
...
INNER JOIN animal a on a.id = mv.animalId
...
ORDER BY mv.date
  ...
  bof <- bof[grepl("INVALID", bof$calfeartag) == FALSE,]
  ...
  prefix10 <- as.factor(substr(bof$calfeartag,1,8))
  
  prefixdf <- data.frame(prefix = levels(prefix10))
  
  for (i in 1:nrow(prefixdf)){
    prefixdf$count[i] <- length(prefix10[prefix10 == prefixdf$prefix[i]])
  }
  
  prefixdf <- prefixdf[order(-prefixdf$count),]
  
  prefix <- prefixdf$prefix[1]
  
  
  calves <- dbGetQuery(con,'
...
')
  ...
  calffinaljohnesstatus <- dbGetQuery(con, '
...
')
  ...
  dam_status_birth <- dbGetQuery(con,'
...
')
  ...
  granddam_status_birth <- dbGetQuery(con, '
...
')
  ...
  granddamntestsbirth <- dbGetQuery(con, '
...
')
  ...
  nsiblingsstatus2birth <- dbGetQuery(con, '
...
')
  ...
  nsiblingsstatus3birth <- dbGetQuery(con, '
...
')
  ...
  nauntsstatus2birth <- dbGetQuery(con, '
...
')
  ...
  nauntsstatus3birth <- dbGetQuery(con, '
...
')
  ...
  ngreatauntsbirth <- dbGetQuery(con, '
...
')
  ...
  ngreatauntsstatus2birth <- dbGetQuery(con, '
...
')
  ...
  ngreatauntsstatus3birth <- dbGetQuery(con, '
...
')
  ...
  damstatus12mold <- dbGetQuery(con, '
...
(SELECT
  ...
  damntests12mold <- dbGetQuery(con, '
...
ORDER BY a.id
  ...
  granddamstatus12mold <- dbGetQuery(con, '
...
(SELECT
  ...
  granddamntests12mold <- dbGetQuery(con, '
...
ORDER BY a.id                      
  ...
  nsiblings12mold <- dbGetQuery(con, '
 ...
 ')
  ...
  nsiblingsstatus212mold <- dbGetQuery(con, '
...
')
  ...
  nsiblingsstatus312mold <- dbGetQuery(con, '
...
')
  ...
  nauntsstatus212mold <- dbGetQuery(con, '
...
')
  ...
  nauntsstatus312mold <- dbGetQuery(con, '
...
')
  ...
  ngreataunts12mold <- dbGetQuery(con, '
...
')
  ...
  ngreatauntsstatus212mold <- dbGetQuery(con, '
...
')
  ...
  ngreatauntsstatus312mold <- dbGetQuery(con, '
...
WHERE a5.id <> 38 AND a5.id <> 39 AND a5.id <> 0 AND 
 ...
 ')
  ...
  allanimalscrtstatus <- dbGetQuery(con, '
...
ORDER BY a.id
  ...
  granddamcrtstatus <- dbGetQuery(con,'
...
')
  ...
  granddamntestscrt <- dbGetQuery(con, '
...
ORDER BY a.id                                      
  ...
  nsiblingsstatus3crt <- dbGetQuery(con, '
...
')
  ...
  nsiblingsstatus2crt <- dbGetQuery(con, '
...
')
  ...
  nauntsstatus3crt <- dbGetQuery(con,'
...
')
  ...
  nauntsstatus2crt <- dbGetQuery(con,'
...
')
  ...
  ngreatauntsstatus3crt <- dbGetQuery(con,'
...
')
  ...
  ngreatauntsstatus2crt <- dbGetQuery(con,'
...
')
  ...
  nposanimalsbydate <- dbGetQuery(con,'
  ...
  meantitrebydate <- dbGetQuery(con,'
  ...
  meantitrenegcowsbydate <- dbGetQuery(con,'
  ...
  herdjohnesdata <- merge(ntested,nrecorded, by = "date", all.x = TRUE)
  
  herdjohnesdata$proptested <- herdjohnesdata$ntested / herdjohnesdata$nrecorded
  

  
  herdjohnesdata <- merge(herdjohnesdata, nposanimalsbydate, by = "date", all.x = TRUE)
  
  
  herdjohnesdata$proppos <- herdjohnesdata$npos / herdjohnesdata$ntested
  
  herdjohnesdata <- merge(herdjohnesdata, meantitrebydate, by = "date", all.x = TRUE)
  
  
  
  herdjohnesdata <- merge(herdjohnesdata, meantitrenegcowsbydate, by = "date", all.x = TRUE)
  
  
  
  earlierherdtestdates <- dbGetQuery(con,'
...
')
  ...
  laterherdtestdates <- dbGetQuery(con,'
...
')
  ...
  nproximal_calves <- dbGetQuery(con,'
...
')
  ...
  nvaguelyproximal_calves <- dbGetQuery(con,'
...
GROUP BY a.id
  ...
  nvaguelyproximaldams <- dbGetQuery(con, '
...
GROUP BY a.id
  ...
  nproximaldamsstatus2birth <- dbGetQuery(con,'
...
')
  ...
  nproximaldamsstatus3birth <- dbGetQuery(con,'
...
')
  ...
  nproximaldamsstatus212mold <- dbGetQuery(con, '
...
ORDER BY a.id                                                        
  ...
  nproximaldamsstatus312mold <- dbGetQuery(con, '
...
ORDER BY a.id                                                     
  ...
  nvaguelyproximaldamsstatus212mold <- dbGetQuery(con, '
...
ORDER BY a.id                                                                   
  ...
  nvaguelyproximaldamsstatus312mold <- dbGetQuery(con, '
...
ORDER BY a.id                                                       
  ...
  nproximaldamsstatus2crt <- dbGetQuery(con,'
...
')
  ...
  nproximaldamsstatus3crt <- dbGetQuery(con,'
...
')
  ...
  nvaguelyproximaldamsstatus2crt <- dbGetQuery(con,'
...
')
  ...
  nvaguelyproximaldamsstatus3crt <- dbGetQuery(con,'
...
')
  ...
  nvaguelyproximaldamsstatus2birth <- dbGetQuery(con,'
...
')
  ...
  nvaguelyproximaldamsstatus3birth <- dbGetQuery(con,'
...
')
  ...
  nproximal_calvesstatus3crt <- dbGetQuery(con,'
...
')
  ...
  nproximal_calvesstatus2crt <- dbGetQuery(con,'
...
')
  ...
  nvaguelyproximal_calvesstatus3crt <- dbGetQuery(con,'
...
')
  ...
  nvaguelyproximal_calvesstatus2crt <- dbGetQuery(con,'
...
')
  ...
  collated$bornonfarm <- ifelse(substr(collated$calfeartag,1,8) == prefix, 1, 0)
  ...
  collated <- collated[,c(1,2,3,4,5,6:122,133,124:132,123,134)]
  ...
  write.csv(data_indi_wide, paste(path,FARM,"_RSQL.csv",sep = ""))
