...
siblings <- as.data.table(dbGetQuery(con, '
  ...
  WHERE a.id <> 38 AND a.id <> 0 AND
    ...
    a3.earTag <> "BARTLETT" AND a3.earTag <> "HUDSON" AND a3.earTag <> "UK" AND a3.earTag <> "" AND
...
a.earTag as aunteartag
 ...
 WHERE a4.id <> 38 AND a4.id <> 39 AND a4.id <> 0 AND a4.damId <> 38 AND a4.damId <> 0 AND 
  ...
  a3.earTag <> "BARTLETT" AND a3.earTag <> "HUDSON" AND a3.earTag <> "UK" AND a3.earTag <> "" AND a3.earTag <> "" AND
  a3.damId <> 38 AND a3.damId <> 0 AND 
  a2.earTag <> "00" AND a2.earTag <> "000" AND SUBSTR(a2.earTag,1,4) <> "0000" AND
  a2.earTag <> "BARTLETT" AND a2.earTag <> "HUDSON" AND a2.earTag <> "UK" AND a2.earTag <> "" AND a2.earTag <> "" AND
...
SELECT
calfid,
count(auntid) as nauntsstatus2birth FROM(
...
a.earTag as aunteartag
 ...
 WHERE a4.id <> 38 AND a4.id <> 39 AND a4.id <> 0 AND a4.damId <> 38 AND a4.damId <> 0 AND 
  ...
  a3.damId <> 38 AND a3.damId <> 0 AND 
  a2.earTag <> "00" AND a2.earTag <> "000" AND SUBSTR(a2.earTag,1,4) <> "0000" AND
  a2.earTag <> "BARTLETT" AND a2.earTag <> "HUDSON" AND a2.earTag <> "UK" AND a2.earTag <> "" AND
  a.sex = "C" AND a.id <> a3.id AND julianday(a.DOB) <= julianday(a4.DOB) AND js.cTVStatus = 2 and julianday(js.start) <= julianday(a4.DOB) AND julianday(js.end) > julianday(a4.DOB)
...
SELECT
calfid,
count(auntid) as nauntsstatus3birth FROM(
...
a.earTag as aunteartag
 ...
 WHERE a4.id <> 38 AND a4.id <> 39 AND a4.id <> 0 AND a4.damId <> 38 AND a4.damId <> 0 AND 
  ...
  a2.earTag <> "00" AND a2.earTag <> "000" AND SUBSTR(a2.earTag,1,4) <> "0000" AND
  a2.earTag <> "BARTLETT" AND a2.earTag <> "HUDSON" AND a2.earTag <> "UK" AND a2.earTag <> "" AND
  a.sex = "C" AND a.id <> a3.id AND julianday(a.DOB) <= julianday(a4.DOB) AND js.cTVStatus = 3 and julianday(js.start) <= julianday(a4.DOB) AND julianday(js.end) > julianday(a4.DOB)
...
WHERE a5.id <> 38 AND a5.id <> 39 AND a5.id <> 0 AND 
  ...
  a4.earTag <> "BARTLETT" AND a4.earTag <> "HUDSON" AND a4.earTag <> "UK" AND a4.earTag <> "" AND
...
ngreatauntsstatus2birth <- as.data.table(dbGetQuery(con, '
   ...
   SELECT
calfid,
count(greatauntid) as ngreatauntsstatus2birth FROM(
...
WHERE a5.id <> 38 AND a5.id <> 39 AND a5.id <> 0 AND 
  ...
  a2.earTag <> "00" AND a2.earTag <> "000" AND SUBSTR(a2.earTag,1,4) <> "0000" AND
  a2.earTag <> "BARTLETT" AND a2.earTag <> "HUDSON" AND a2.earTag <> "UK" AND a2.earTag <> "" AND
  a.sex = "C" AND a.id <> a3.id AND julianday(a.DOB) <= julianday(a5.DOB) AND js.cTVStatus = 2 AND js.start <= a5.DOB AND js.end > a5.DOB
...
ngreatauntsstatus3birth <- as.data.table(dbGetQuery(con, '
   ...
   SELECT
calfid,
count(greatauntid) as ngreatauntsstatus3birth FROM(
...
WHERE a5.id <> 38 AND a5.id <> 39 AND a5.id <> 0 AND 
  ...
  a2.earTag <> "00" AND a2.earTag <> "000" AND SUBSTR(a2.earTag,1,4) <> "0000" AND
  a2.earTag <> "BARTLETT" AND a2.earTag <> "HUDSON" AND a2.earTag <> "UK" AND a2.earTag <> "" AND
  a.sex = "C" AND a.id <> a3.id AND julianday(a.DOB) <= julianday(a5.DOB) AND js.cTVStatus = 3 AND js.start <= a5.DOB AND js.end > a5.DOB
...
FROM(
	...
	max(js.start) as siblinglatesttest,
	js.cTVStatus
...
max(js.start)
 ...
 WHERE a4.id <> 38 AND a4.id <> 39 AND a4.id <> 0 AND 
  ...
  a3.damId <> 38 AND a3.damId <> 0 AND a2.earTag <> "00" AND a2.earTag <> "000" AND SUBSTR(a2.earTag,1,4) <> "0000" AND
  a2.earTag <> "BARTLETT" AND a2.earTag <> "HUDSON" AND a2.earTag <> "UK" AND a2.earTag <> "" AND
  a.sex = "C" AND a.id <> a3.id  AND js.cTVStatus = 3 
...
max(js.start)
 ...
 WHERE a4.id <> 38 AND a4.id <> 39 AND a4.id <> 0 AND 
  ...
  a3.damId <> 38 AND a3.damId <> 0 AND a2.earTag <> "00" AND a2.earTag <> "000" AND SUBSTR(a2.earTag,1,4) <> "0000" AND
  a2.earTag <> "BARTLETT" AND a2.earTag <> "HUDSON" AND a2.earTag <> "UK" AND a2.earTag <> "" AND
  a.sex = "C" AND a.id <> a3.id  AND js.cTVStatus = 2
...
ngreatauntsstatus3crt <- as.data.table(dbGetQuery(con,'
 ...
 SELECT
calfid,
count(auntid) as ngreatauntsstatus3crt FROM(
...
ngreatauntsstatus2crt <- as.data.table(dbGetQuery(con,'
 ...
 SELECT
calfid,
count(auntid) as ngreatauntsstatus2crt FROM(
...
proximal_calves <- as.data.table(dbGetQuery(con,'
                                            
  SELECT
                      
  a.id AS calfid,
  mv.animalId AS proximalcalfid,
  a2.Eartag as proximalcalfeartag,
  mv.date AS proximalcalfdob
...
vaguely_proximal_calves <- as.data.table(dbGetQuery(con,'
                                            
    SELECT
    
    a.id AS calfid,
    mv.animalId AS vaguelyproximalcalfid,
    a2.Eartag as vaguelyproximalcalfeartag,
    mv.date AS vaguelyproximalcalfdob
...
calfid,
count(calfid) as nproximaldamsstatus2crt
...
FROM(
  ...
  a.id AS calfid,
  a.earTag as calfeartag,
  a2.id as proximalcalfid,
  a2.earTag as proximalcalfeartag,
  mv.date as proximalcalfdob,
  a3.id as proximaldamid,
  a3.earTag as proximaldameartag,
  max(js.start) as proximaldamlatesttest,
  js.cTVStatus
...
calfid,
count(calfid) as nproximaldamsstatus3crt
...
calfid,
count(calfid) as nvaguelyproximaldamsstatus2crt
...
calfid,
count(calfid) as nvaguelyproximaldamsstatus3crt
...
nproximal_calvesstatus3crt <- as.data.table(dbGetQuery(con,'
    ...
    SELECT calfid,
    count(cTVStatus) as nproximalcalvesstatus3crt
    ...
    FROM (
      ...
      a2.id AS calfid,
      mv.animalId AS proximalcalfid,
      a.Eartag as proximalcalfeartag,
      mv.date AS proximalcalfdob,
      max(js.start),
      js.cTVStatus
                                                    
                                                       
      FROM animal a2, movement mv
                                                       
      INNER JOIN animal a ON mv.animalId = a.id
      INNER JOIN johnes_state_2 js on a.id = js.animalId
                                                       
      WHERE julianday(a2.DOB) - julianday(mv.date) <= 10 
      AND julianday(a2.DOB) - julianday(mv.date) >=-10 
      AND mv.type = 1
      AND a2.id <> mv.animalId
...
nproximal_calvesstatus2crt <- as.data.table(dbGetQuery(con,'
    ...
    SELECT calfid,
    count(cTVStatus) as nproximalcalvesstatus2crt
...
nvaguelyproximal_calvesstatus3crt <- as.data.table(dbGetQuery(con,'
    ...
    SELECT calfid,
    count(cTVStatus) as nvaguelyproximalcalvesstatus3crt
    ...
    FROM (
      ...
      WHERE julianday(a2.DOB) - julianday(mv.date) <= 70 
      AND julianday(a2.DOB) - julianday(mv.date) >=- 70 
      AND mv.type = 1
      AND a2.id <> mv.animalId
...
nvaguelyproximal_calvesstatus2crt <- as.data.table(dbGetQuery(con,'
    ...
    SELECT calfid,
    count(cTVStatus) as nvaguelyproximalcalvesstatus2crt
...
collated <- collated[,c(1,3,4,5:89,2,100,91:99,90,101)]
