...
data <- read.csv(paste0(path,farm,"_RSQL.csv"))

print("Combining milk recording data...")

alpha <- (ncol(data)-140)/12 #Max number of titres in testing data



  
if(alpha >= 1){data <- tidyr::unite(data, covsandtitre1, c(123:134), remove = TRUE, sep = ":")}
if(alpha >= 2){data <- tidyr::unite(data, covsandtitre2, c(124:135), remove = TRUE, sep = ":")}
if(alpha >= 3){data <- tidyr::unite(data, covsandtitre3, c(125:136), remove = TRUE, sep = ":")}
if(alpha >= 4){data <- tidyr::unite(data, covsandtitre4, c(126:137), remove = TRUE, sep = ":")}
if(alpha >= 5){data <- tidyr::unite(data, covsandtitre5, c(127:138), remove = TRUE, sep = ":")}
if(alpha >= 6){data <- tidyr::unite(data, covsandtitre6, c(128:139), remove = TRUE, sep = ":")}
if(alpha >= 7){data <- tidyr::unite(data, covsandtitre7, c(129:140), remove = TRUE, sep = ":")}
if(alpha >= 8){data <- tidyr::unite(data, covsandtitre8, c(130:141), remove = TRUE, sep = ":")}
if(alpha >= 9){data <- tidyr::unite(data, covsandtitre9, c(131:142), remove = TRUE, sep = ":")}
if(alpha >= 10){data <- tidyr::unite(data, covsandtitre10, c(132:143), remove = TRUE, sep = ":")}
if(alpha >= 11){data <- tidyr::unite(data, covsandtitre11, c(133:144), remove = TRUE, sep = ":")}
if(alpha >= 12){data <- tidyr::unite(data, covsandtitre12, c(134:145), remove = TRUE, sep = ":")}
if(alpha >= 13){data <- tidyr::unite(data, covsandtitre13, c(135:146), remove = TRUE, sep = ":")}
if(alpha >= 14){data <- tidyr::unite(data, covsandtitre14, c(136:147), remove = TRUE, sep = ":")}
if(alpha >= 15){data <- tidyr::unite(data, covsandtitre15, c(137:148), remove = TRUE, sep = ":")}
if(alpha >= 16){data <- tidyr::unite(data, covsandtitre16, c(138:149), remove = TRUE, sep = ":")}
if(alpha >= 17){data <- tidyr::unite(data, covsandtitre17, c(139:150), remove = TRUE, sep = ":")}
if(alpha >= 18){data <- tidyr::unite(data, covsandtitre18, c(140:151), remove = TRUE, sep = ":")}
if(alpha >= 19){data <- tidyr::unite(data, covsandtitre19, c(141:152), remove = TRUE, sep = ":")}
if(alpha >= 20){data <- tidyr::unite(data, covsandtitre20, c(142:153), remove = TRUE, sep = ":")}
if(alpha >= 21){data <- tidyr::unite(data, covsandtitre21, c(143:154), remove = TRUE, sep = ":")}
if(alpha >= 22){data <- tidyr::unite(data, covsandtitre22, c(144:155), remove = TRUE, sep = ":")}
if(alpha >= 23){data <- tidyr::unite(data, covsandtitre23, c(145:156), remove = TRUE, sep = ":")}
if(alpha >= 24){data <- tidyr::unite(data, covsandtitre24, c(146:157), remove = TRUE, sep = ":")}
if(alpha >= 25){data <- tidyr::unite(data, covsandtitre25, c(147:158), remove = TRUE, sep = ":")}
if(alpha >= 26){data <- tidyr::unite(data, covsandtitre26, c(148:159), remove = TRUE, sep = ":")}
if(alpha >= 27){data <- tidyr::unite(data, covsandtitre27, c(149:160), remove = TRUE, sep = ":")}
if(alpha >= 28){data <- tidyr::unite(data, covsandtitre28, c(150:161), remove = TRUE, sep = ":")}
if(alpha >= 29){data <- tidyr::unite(data, covsandtitre29, c(151:162), remove = TRUE, sep = ":")}
if(alpha >= 30){data <- tidyr::unite(data, covsandtitre30, c(152:163), remove = TRUE, sep = ":")}
if(alpha >= 31){data <- tidyr::unite(data, covsandtitre31, c(153:164), remove = TRUE, sep = ":")}
if(alpha >= 32){data <- tidyr::unite(data, covsandtitre32, c(154:165), remove = TRUE, sep = ":")}
if(alpha >= 33){data <- tidyr::unite(data, covsandtitre33, c(155:166), remove = TRUE, sep = ":")}
if(alpha >= 34){data <- tidyr::unite(data, covsandtitre34, c(156:167), remove = TRUE, sep = ":")}
if(alpha >= 35){data <- tidyr::unite(data, covsandtitre35, c(157:168), remove = TRUE, sep = ":")}
if(alpha >= 36){data <- tidyr::unite(data, covsandtitre36, c(158:169), remove = TRUE, sep = ":")}
if(alpha >= 37){data <- tidyr::unite(data, covsandtitre37, c(159:170), remove = TRUE, sep = ":")}
if(alpha >= 38){data <- tidyr::unite(data, covsandtitre38, c(160:171), remove = TRUE, sep = ":")}
if(alpha >= 39){data <- tidyr::unite(data, covsandtitre39, c(161:172), remove = TRUE, sep = ":")}
if(alpha >= 40){data <- tidyr::unite(data, covsandtitre40, c(162:173), remove = TRUE, sep = ":")}
...
data$prophorizontalrelsstatus212mold_cat <- cut(data$prophorizontalrelsstatus212mold, breaks = c(-0.001,0.333,0.667,1))
...
data$prophorizontalrelsstatus2crt_recat <- cut(data$prophorizontalrelsstatus2crt, breaks = c(-0.001,0.333,1))
levels(data$prophorizontalrelsstatus2crt_recat) <- c(levels(data$prophorizontalrelsstatus2crt_recat), "Unknown")
data$prophorizontalrelsstatus2crt_recat[is.na(data$prophorizontalrelsstatus2crt_recat)] <- "Unknown"
...
data <- cbind(tempdata, data[,c(123:(122+alpha))])
...
data$Target_QMMS <- as.factor(ifelse(grepl("HH", data$profile) == TRUE |
...
finalpriormodel_birth <- readRDS("y:/ian/johnesthresholds/johnesproper/data/pickledmodels/priormodels/finalpriormodel_birth.rds")
finalpriormodel_12mold <- readRDS("y:/ian/johnesthresholds/johnesproper/data/pickledmodels/priormodels/finalpriormodel_12mold.rds")
finalpriormodel_crt <- readRDS("y:/ian/johnesthresholds/johnesproper/data/pickledmodels/priormodels/finalpriormodel_crt.rds")
...
#Set prior probabilities to average for animals not born on farm

data$priorprob_birth[data$bornonfarm == "0"] <- 0.19
data$priorprob_12mold[data$bornonfarm == "0"] <- 0.19 
data$priorprob_crt[data$bornonfarm == "0"] <- 0.19
...
print("Saving data (data_TESTFARMS_birthpriors.csv)")

write.csv(data, paste0(path,"data_TESTFARMS_birthpriors.csv"), row.names = FALSE)
