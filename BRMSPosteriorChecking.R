...
print("Reading data (data_brms.csv)")
data_postchecks <- read.csv("y:/ian/johnesthresholds/johnesproper/data/brmsmodelresults/excludingbaddata/BRMSAgeYieldSCCMTNCDIMIndSimulated1MBF/data_brms.csv")

uniquecows <- unique(data_postchecks$calfeartag)

#regcores(-1)
#
#missing <- foreach (cow = uniquecows, .combine = "c") %dopar% {
#  tempdata <- data_postchecks[data_postchecks$calfeartag == cow,]
...
#data_postchecks <- data_postchecks[data_postchecks$calfeartag %in% ms_df$cow,]
...
if(POUpdateMode == "floor"){ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsAtPOIPOFloor",posterioroddsfloor,".png"))}
if(POUpdateMode == "lastxtests"){ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsAtPOILast",lastxtests,"tests.png"))}
if(POUpdateMode == "birthfraction"){ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsAtPOIPOFloor",birthoddsfraction,"birthodds.png"))}
...
print(ggplot(data_postchecks[which((data_postchecks$age - data_postchecks$refage) == 0),], aes(x= predLR_cat, y = PosteriorProb)) +
  geom_boxplot() +
  theme(axis.text.x=element_text(angle= -90)) +
  labs(title = "Posterior Probability at period of interest", subtitle = paste0("\nPOFloor:", posterioroddsfloor), x = "Birth Probability", y = "Posterior Probability")) +
  facet_wrap(~profilegroup)

ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/groupsposteriorchecks/plots/PosteriorAtPOIbyBirthProbPOF",posterioroddsfloor,".png"))
...
if(POUpdateMode == "lastxtests"){
  ...
  print(ggplot(data_postchecks[which((data_postchecks$age - data_postchecks$refage) == 0),], aes(x= predLR_cat, y = PosteriorProb)) +
          geom_boxplot() +
          theme(axis.text.x=element_text(angle= -90)) +
          labs(title = "Posterior Probability on day of period of interest", subtitle = paste0("\nLast ",lastxtests," tests"), x = "Birth Probability", y = "Posterior Probability") +
          facet_wrap(~profilegroup))
  
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/groupsposteriorchecks/plots/PosteriorAtPOIbyBirthProbLast",lastxtests,"Tests.png"))
...
if(POUpdateMode == "birthfraction"){
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/groupsposteriorchecks/plots/PosteriorAtPOIbyBirthProbPOF",birthoddsfraction,"birthodds.png"))
...
if(POUpdateMode == "floor"){
  ...
  theme(axis.text.x=element_text(angle= -90)) 
ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsWithin",dpriorpoicuts[i]+1,"to",dpriorpoicuts[i+1],"daysbeforePOIPOFloor",posterioroddsfloor,".png"))
}
...
if(POUpdateMode == "lastxtests"){
  ggplot() +
    ...
    theme(axis.text.x=element_text(angle= -90)) 
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsWithin",dpriorpoicuts[i]+1,"to",dpriorpoicuts[i+1],"daysbeforePOILast",lastxtests,"tests.png"))
  ...
  if(POUpdateMode == "birthfraction"){
    ...
    ggplot() +
      ...
      theme(axis.text.x=element_text(angle= -90)) 
    ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsWithin",dpriorpoicuts[i]+1,"to",dpriorpoicuts[i+1],"daysbeforePOIPOFloor",birthoddsfraction,"birthodds.png"))
  }
...
#    theme(axis.text.x = element_text(angle = -90)))
  #ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/Scatter",i,"RelToPOIPOFloor",posterioroddsfloor,".png"))
#}
...
#            theme(axis.text.x = element_text(angle = -90)))
    #ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/Scatter",i,"RelToPOILast",lastxtests,"tests.png"))
#  }
...
#            theme(axis.text.x = element_text(angle = -90)))
    #ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/Scatter",i,"RelToPOIPOFloor",birthoddsfraction,"birthodds.png"))
#  }
...
print(ggplot() +
  ...
  theme(axis.text.x = element_text(angle = -90)))
ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsProbAtBirth.png"))
...
for(i in 1:length(testlist)){
  ...
  print(ggplot() +
    ...
    theme(axis.text.x = element_text(angle = -90)))
ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/POFloor",posterioroddsfloor,"BoxGroupsProbAfter",i,"Tests.png"))
  }
  ...
  if(POUpdateMode == "lastxtests"){
    print(ggplot() +
            ...
            theme(axis.text.x = element_text(angle = -90)))
    ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/Last",lastxtests,"testsBoxGroupsProbAfter",i,"Tests.png"))
  }
  ...
  if(POUpdateMode == "birthfraction"){
    print(ggplot() +
            ...
            theme(axis.text.x = element_text(angle = -90)))
    ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/POFloor",birthoddsfraction,"birthoddsBoxGroupsProbAfter",i,"Tests.png"))
  }
}
...
ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsFinalPosteriorsPOFloor",posterioroddsfloor,".png"))
}
...
if(POUpdateMode == "lastxtests"){
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsFinalPosteriorsLast",lastxtests,"tests.png"))
...
if(POUpdateMode == "birthfraction"){
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/BoxGroupsFinalPosteriorsPOFloor",birthoddsfraction,"birthodds.png"))
}
...
ggplot(data_postchecks_lasttest, aes(x = predLR_cat, y = PosteriorProb)) +
  geom_boxplot() +
  theme(axis.text.x = element_text(angle = -90)) +
  labs(title = "Final posterior of animals by birth probability", subtitle = paste0("\nPOFloor ",posterioroddsfloor), x = "Birth Probability", y = "Posterior Probability") +
  facet_wrap(~profilegroup)

  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/groupsposteriorchecks/plots/FinalPosteriorsbyBirthProbPOF",posterioroddsfloor,".png"))
}  
...
if(POUpdateMode == "lastxtests"){
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/groupsposteriorchecks/plots/FinalPosteriorsbyBirthProbLast",lastxtests,"Tests.png"))
}
...
if(POUpdateMode == "birthfraction"){
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/groupsposteriorchecks/plots/FinalPosteriorsbyBirthProbPOF",birthoddsfraction,"birthodds.png"))
}  
...
for (cow in unique(outlierdata$calfeartag)){
  ...
  if(POUpdateMode == "floor"){
    ggplot(data_postchecks[data_postchecks$calfeartag == cow,], aes(x = age)) +
      ...
      labs(title = data_postchecks$calfeartag[data_postchecks$calfeartag == cow], subtitle = paste0("Birth Probability:", round(data_postchecks$priorprob_crt[data_postchecks$calfeartag == cow],2)))
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Outliers/",cow,"PFloor",posterioroddsfloor,".png"))
  }
  ...
  if(POUpdateMode == "lastxtests"){
    ...
    ggplot(data_postchecks[data_postchecks$calfeartag == cow,], aes(x = age)) +
      ...
      geom_hline(yintercept = 20, linetype = "dashed", color = "orange") +
      scale_y_continuous(name = "Titre", sec.axis = sec_axis(~./100, name="Posterior Probability")) +
      labs(title = cow, subtitle = paste("\n",birthmodel, "Birth Probability:", round(data_postchecks$priorprob_crt[data_postchecks$calfeartag == cow],2),"\nLast ",lastxtests," tests"))
    
    ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Outliers/",cow,"Last",lastxtests,"tests.png"))
  ...
  if(POUpdateMode == "birthfraction"){
    ...
    ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Outliers/",cow,"PFloor",birthoddsfraction,"birthodds.png"))
  }
}
}
...
if(POUpdateMode == "floor" & posterioroddsfloor != 0){
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/PosteriorFloorApplied/",cow,"PFloor",posterioroddsfloor,".png"))
  }
}
...
if(POUpdateMode == "birthfraction"){
  ...
  for (cow in unique(data_postchecks$calfeartag[which(data_postchecks$POFloorApplied == 1 & data_postchecks$nH >= 1)])[1:50]){
    ggplot(data_postchecks[data_postchecks$calfeartag == cow,], aes(x = age)) +
      ...
      geom_hline(yintercept = 20, linetype = "dashed", color = "orange") +
      scale_y_continuous(name = "Titre", sec.axis = sec_axis(~./100, name="Posterior Probability")) +
      labs(title = data_postchecks$calfeartag[data_postchecks$calfeartag == cow], subtitle = paste("\n",birthmodel, "Birth Probability:", round(data_postchecks$priorprob_crt[data_postchecks$calfeartag == cow],2),"\nPOFloor ",birthoddsfraction," * birth odds"))
    ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/PosteriorFloorApplied/",cow,"PFloor",birthoddsfraction,"birthodds.png"))
  }
}
...
ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/Titres",toString(cutpoints),"Ages",toString(agebreaks),"AllLowOneHFinalPOF",posterioroddsfloor,".png"))
...
if(POUpdateMode == "lastxtests"){
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/Titres",toString(cutpoints),"Ages",toString(agebreaks),"AllLowOneHFinalLast",lastxtests,"tests.png"))
...
if(POUpdateMode == "birthfraction"){
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/Titres",toString(cutpoints),"Ages",toString(agebreaks),"AllLowOneHFinalPOF",birthoddsfraction,"birthodds.png"))
...
ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/Titres",toString(cutpoints),"Ages",toString(agebreaks),"AllLowOneHFinalPOFvsNoPOFatPOIPOF",posterioroddsfloor,".png"))
...
ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/AllLowOneHFinalByLikelihoodPOF",posterioroddsfloor,".png"))
...
if(POUpdateMode == "birthfraction"){
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/Titres",toString(cutpoints),"Ages",toString(agebreaks),"AllLowOneHFinalPOFvsNoPOFatPOIPOF",birthoddsfraction,"birthodds.png"))
  ...
  ggsave(paste0("y:/ian/johnesthresholds/johnesproper/data/GroupsPosteriorChecks/Plots/AllLowOneHFinalByLikelihoodPOF",birthoddsfraction,"birthodds.png"))
