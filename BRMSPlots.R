...
####DROP COWS WITH MISSING YIELD, MTNC, SCC####
...
testcows <- testcows[testcows %in% data$calfeartag]
...
for (cow in testcows){
  ...
  if(POUpdateMode == "floor"){ggsave(paste("y:/ian/johnesthresholds/johnesproper/data/PosteriorProbCharts/TestCows/",cow,"PFloor",posterioroddsfloor,".png"))}
  if(POUpdateMode == "lastxtests"){ggsave(paste("y:/ian/johnesthresholds/johnesproper/data/PosteriorProbCharts/TestCows/",cow,"Last",lastxtests,"tests.png"))}
  if(POUpdateMode == "birthfraction"){ggsave(paste("y:/ian/johnesthresholds/johnesproper/data/PosteriorProbCharts/TestCows/",cow,birthoddsfraction,"birthprob.png"))}
  if(POUpdateMode == "ignoreuntil"){ggsave(paste("y:/ian/johnesthresholds/johnesproper/data/PosteriorProbCharts/TestCows/",cow,"IgnoreUntil",ignorethreshold,".png"))}
}
